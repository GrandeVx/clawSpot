...
import { z, ZodSchema, ZodObject, ZodOptional, ZodString } from 'zod';
import * as better_call from 'better-call';
import { Endpoint, EndpointResponse, ContextTools, EndpointOptions, CookieOptions, Context, Prettify as Prettify$1 } from 'better-call';
import { L as LiteralString, D as DeepPartial, U as UnionToIntersection, S as StripEmptyObjects, O as OmitId, P as Prettify } from './helper-DrEEwdyQ.cjs';
import { S as SocialProviders, b as SocialProviderList, a as OAuthProvider } from './index-BNVrpPYq.cjs';
...
declare const createAuthEndpoint: <Path extends string, Opts extends better_call.EndpointOptions, R extends EndpointResponse>(path: Path, options: Opts, handler: (ctx: better_call.InferBody<Opts, Opts["body"] & (undefined extends better_call.InferUseOptions<Opts>["body"] ? {} : better_call.InferUseOptions<Opts>["body"])> & better_call.InferParam<Path, better_call.InferParamPath<Path>, better_call.InferParamWildCard<Path>> & better_call.InferMethod<Opts["method"]> & better_call.InferHeaders<Opts, Opts["requireHeaders"]> & better_call.InferRequest<Opts, Opts["requireRequest"]> & better_call.InferQuery<Opts["query"]> & {
    ...
    <C extends HasRequiredKeys<better_call.Context<Path, Opts>> extends true ? [better_call.Context<Path, Opts>] : [(better_call.Context<Path, Opts> | undefined)?]>(...ctx: C): Promise<C extends [{
        asResponse: true;
    }] ? Response : R extends {
        _flag: "json";
    } ? R extends {
...
type FieldAttributeConfig<T extends FieldType = FieldType> = {
    ...
    transform?: {
        ...
        output?: (value: Primitive) => InferValueType<T> | Promise<InferValueType<T>>;
    };
    /**
...
declare const createInternalAdapter: (adapter: Adapter, ctx: {
    ...
    updateSession: (sessionId: string, session: Partial<Session> & Record<string, any>) => Promise<any>;
    deleteSession: (id: string) => Promise<void>;
    deleteSessions: (userIdOrSessions: string | string[]) => Promise<void>;
    ...
    createVerificationValue: (data: Omit<Verification, "createdAt" | "id"> & Partial<Verification>) => Promise<{
        id: string;
        expiresAt: Date;
        value: string;
        createdAt: Date;
...
declare const getSessionFromCtx: <U extends Record<string, any> = Record<string, any>, S extends Record<string, any> = Record<string, any>>(ctx: GenericEndpointContext) => Promise<{
    session: S & Session;
    user: U & User;
}>;
...
declare const listSessions: <Option extends BetterAuthOptions>() => {
    <C extends [Context<"/list-sessions", {
        method: "GET";
...
declare const revokeSession: {
    <C extends [Context<"/revoke-session", {
        method: "POST";
        body: z.ZodObject<{
            id: z.ZodString;
        }, "strip", z.ZodTypeAny, {
...
declare const revokeSessions: {
    <C extends [Context<"/revoke-sessions", {
        method: "POST";
        use: better_call.Endpoint<better_call.Handler<string, better_call.EndpointOptions, {
            session: {
                session: Record<string, any> & {
...
declare const revokeOtherSessions: {
    <C extends [Context<"/revoke-other-sessions", {
        method: "POST";
        requireHeaders: true;
        use: better_call.Endpoint<better_call.Handler<string, better_call.EndpointOptions, {
            session: {
...
declare const updateUser: <O extends BetterAuthOptions>() => {
    <C extends HasRequiredKeys<better_call.Context<"/update-user", {
        method: "POST";
        body: ZodObject<{
...
declare const signUpEmail: <O extends BetterAuthOptions>() => {
    <C extends HasRequiredKeys<better_call.Context<"/sign-up/email", {
        method: "POST";
        query: z.ZodOptional<z.ZodObject<{
            currentURL: z.ZodOptional<z.ZodString>;
        }, "strip", z.ZodTypeAny, {
...
declare function getEndpoints<C extends AuthContext, Option extends BetterAuthOptions>(ctx: Promise<C> | C, options: Option): {
    api: {
        ...
        signUpEmail: {
            <C_1 extends HasRequiredKeys<better_call.Context<"/sign-up/email", {
                method: "POST";
                query: zod.ZodOptional<zod.ZodObject<{
                    currentURL: zod.ZodOptional<zod.ZodString>;
                }, "strip", zod.ZodTypeAny, {
        ...
        updateUser: {
            <C_1 extends HasRequiredKeys<better_call.Context<"/update-user", {
                method: "POST";
                body: zod.ZodObject<{
...
export { type InferFieldsInput as $, type Auth as A, type BetterAuthOptions as B, logger as C, optionsMiddleware as D, type EligibleCookies as E, createAuthMiddleware as F, type GenericEndpointContext as G, type HookEndpointContext as H, type InferUser as I, createAuthEndpoint as J, type KyselyDatabaseType as K, type LogLevel as L, type AuthEndpoint as M, type AuthMiddleware as N, type FieldAttribute as O, type PluginSchema as P, type FieldType as Q, type RateLimit as R, type Session as S, createInternalAdapter as T, type User as U, type InternalAdapter as V, type Where as W, type FieldAttributeConfig as X, createFieldAttribute as Y, type InferValueType as Z, type InferFieldsOutput as _, type AdditionalUserFieldsInput as a, type InferFieldsInputClient as a0, type PluginFieldAttribute as a1, type InferFieldsFromPlugins as a2, type InferFieldsFromOptions as a3, type BetterAuthDbSchema as a4, getAuthTables as a5, getEndpoints as a6, router as a7, signInSocial as a8, signInEmail as a9, callbackOAuth as aa, getSession as ab, getSessionFromCtx as ac, sessionMiddleware as ad, listSessions as ae, revokeSession as af, revokeSessions as ag, revokeOtherSessions as ah, signOut as ai, forgetPassword as aj, forgetPasswordCallback as ak, resetPassword as al, createEmailVerificationToken as am, sendVerificationEmail as an, verifyEmail as ao, updateUser as ap, changePassword as aq, setPassword as ar, deleteUser as as, changeEmail as at, error as au, ok as av, signUpEmail as aw, listUserAccounts as ax, linkSocialAccount as ay, originCheckMiddleware as az, betterAuth as b, type AdditionalUserFieldsOutput as c, type AdditionalSessionFieldsInput as d, type AdditionalSessionFieldsOutput as e, type InferSession as f, type InferPluginTypes as g, type AuthContext as h, init as i, type BetterAuthPlugin as j, type InferOptionSchema as k, type Adapter as l, type AdapterInstance as m, type SecondaryStorage as n, createCookieGetter as o, getCookies as p, type BetterAuthCookies as q, deleteSessionCookie as r, setSessionCookie as s, parseCookies as t, parseSetCookieHeader as u, levels as v, shouldPublishLog as w, type Logger as x, type LogHandlerParams as y, createLogger as z };
