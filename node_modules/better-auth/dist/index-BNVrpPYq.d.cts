import { L as LiteralString, P as Prettify } from './helper-DrEEwdyQ.cjs';
...
interface GitlabOptions extends ProviderOptions {
    issuer?: string;
}
...
interface LinkedInOptions extends ProviderOptions {
}
...
interface DropboxOptions extends ProviderOptions {
}
...
type SocialProviders = typeof socialProviders extends {
...
export { type AppleProfile as A, twitter as B, type DropboxProfile as C, type DiscordProfile as D, type DropboxOptions as E, type FacebookProfile as F, type GithubProfile as G, dropbox as H, type LinkedInOptions as I, linkedin as J, type GitlabProfile as K, type LinkedInProfile as L, type MicrosoftEntraIDProfile as M, type GitlabOptions as N, type OAuth2Tokens as O, type ProviderOptions as P, gitlab as Q, type SocialProviders as S, type TwitchProfile as T, type OAuthProvider as a, type SocialProviderList as b, socialProviderList as c, type GithubOptions as d, type GoogleProfile as e, type GoogleOptions as f, github as g, google as h, type AppleNonConformUser as i, type AppleOptions as j, apple as k, getApplePublicKey as l, type MicrosoftOptions as m, microsoft as n, type DiscordOptions as o, discord as p, type SpotifyProfile as q, type SpotifyOptions as r, socialProviders as s, spotify as t, type TwitchOptions as u, twitch as v, type FacebookOptions as w, facebook as x, type TwitterProfile as y, type TwitterOption as z };
